...
class MediaCheckbox {
    ...
    mediaEditValid(managerId: string): void {
        ...
        // console.log("mediaEditValid vscode.postMessage", message);
...
class MediaCheckboxManager {
    ...
    mediaRowDropped(_row: Element): void {
        ...
        // console.log(this.id, "mediaRowDropped vscode.postMessage", message);
        vscode.postMessage(message);
    ...
    mediaRemoveChild(elt: MediaCheckbox): void {
        ...
        message[elt.id] = true;
        // console.log(this.id, "mediaRemoveChild vscode.postMessage", message);
        vscode.postMessage(message);
    ...
    mediaAddNewChild(label: string, value: boolean): MediaCheckbox {
        ...
        // console.log(this.id, "mediaAddNewChild vscode.postMessage", message);
        vscode.postMessage(message);
...
export class MediaMmi {
    private readonly textToSearch: HistoryInput;
	...
	constructor() {
        this.textToSearch  = new HistoryInput('text-to-search', 'Text to search',
                                              this.mediaOnTextToSearchModified.bind(this),
                                              this.mediaOnTextToSearchValidated.bind(this));
        ...
        this.textToSearch.select();
        // At beginning (which includes editor tab switching)
    }

    mediaInit(): void {
        this.sensitiveCase.addEventListener('input', (event: any) => {
            this.mediaSaveFocusItem(event);
        ...
        window.addEventListener('message', event => {
            ...
            switch (message.command) {
                case 'focus':
                    ...
                    break;
                case 'history':
                    this.textToSearch.setHistory(message.history);
                    break;
                default:
    ...
    private mediaOnTextToSearchModified(event: any): void {
        console.log("mediaOnTextToSearchModified", event);
        this.mediaSearchIncremental(event);
    }
    private mediaOnTextToSearchValidated(_event: any): void {
        // Nothing to do right now, as mediaOnTextToSearchModified have been called before
        // console.log("mediaOnTextToSearchValidated", event);
        // this.mediaSearchIncremental(event);
    }
