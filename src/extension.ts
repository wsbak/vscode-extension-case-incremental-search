...
class CaseSearchPanel {
	...
	private _getHtmlForWebview(webview: vscode.Webview) {
		...
		const scriptMmiShareUri = webview.asWebviewUri(vscode.Uri.joinPath(mediaPathOnDisk, 'mmi_share.js'));
		...
		return `<!DOCTYPE html>
			...
			<body>
				...
				<div class="container">
					<div>
						<fieldset id="filesToInclude">
							<legend>Files to include</legend>
							${filesToIncludeHtml}
						</fieldset>
					</div>
					<div>
						<fieldset id="filesToExclude">
				...
				<script nonce="${nonce}" src="${scriptMmiShareUri}"></script>
